...
const BENEFITS = [
  {
    icon: Shield,
    text: "Les pièges juridiques à éviter absolument",
    accent: "from-blue-500/20 to-blue-600/5",
  },
  {
    icon: Zap,
    text: "Les erreurs fiscales qui coûtent cher",
    accent: "from-amber-500/20 to-amber-600/5",
  },
  {
    icon: BookOpen,
    text: "La méthode pour démarrer sereinement",
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2">
              ...
              <div className="p-10 md:p-14 lg:p-16 flex flex-col justify-center">
                <motion.div variants={fadeUp}>
                  <h3
                    className="font-[family-name:var(--font-montserrat)] font-bold text-[var(--text-primary)] leading-[1.2] text-center sm:text-left"
                    style={{ fontSize: "clamp(1.25rem, 2.5vw, 1.75rem)" }}
                  >
                    Les 7 erreurs fatales de l&apos;entrepreneur au Maroc
                  </h3>

                  <p className="mt-4 text-[var(--text-secondary)] text-[15px] leading-relaxed max-w-md text-center sm:text-left">
                    Un guide complet pour éviter les pièges et démarrer votre
                    projet sur de bonnes bases.
                  </p>
                </motion.div>
                ...
                <motion.ul variants={fadeUp} className="mt-8 space-y-3">
                  {BENEFITS.map((b) => (
                    <li
                      key={b.text}
                      className={`flex items-center gap-4 p-3.5 rounded-xl bg-gradient-to-r ${b.accent} border border-white/[0.05]`}
                    >
                  ...
                  {downloadTriggered ? (
                      ...
                      <p className="text-sm text-[var(--text-secondary)] mb-8 leading-relaxed">
                        ...
                        {(emailError || globalError) && (
                          <span className="block text-[var(--accent)] text-xs mt-2">
                            Note: Un problème technique est survenu, mais votre
                            PDF est prêt.
                          </span>
                        )}
                      </p>
                    ...
                    <>
                      <div className="text-center mb-8">
                        ...
                        <h3 className="font-[family-name:var(--font-montserrat)] font-bold text-xl text-[var(--text-primary)] mb-2 text-center">
                          Téléchargez le guide
                        </h3>
                        <p className="text-sm text-[var(--text-secondary)] leading-relaxed">
                          Entrez vos coordonnées et recevez le PDF
                          instantanément.
                        </p>
                      </div>
                      ...
                      >
                        <div>
                          <label
                            ...
                            className="text-[11px] font-semibold tracking-[0.15em] uppercase text-[var(--text-muted)] mb-2 block"
                          >
                            Prénom
                          </label>
                          <input
