      ...
      <div className="benefits-wrap">
        ...
        <header className="benefits-header">
          ...
          <p className="benefits-meta">
            Le Maroc : croissance, diaspora mondiale, Vision 2030, Coupe du
            Monde 2030. Découvrez les bénéfices d’entreprendre au Maroc.
          </p>
        </header>
            ...
            <div className="kpi-card">
              ...
              <div className="kpi-content">
                ...
                <div className="kpi-label">
                  Marocains du monde → réseau global
                </div>
              </div>
            </div>
          ...
          <ul className="benefits-list">
            ...
            <li>
              ...
              <div className="benefit-text">
                <span className="benefit-label">
                  Coupe d’Afrique 2025 & Coupe du Monde 2030 :
                </span>
                <span className="benefit-desc">
                  milliards investis en infrastructures.
                </span>
              </div>
            </li>
            ...
            <li>
              ...
              <div className="benefit-text">
                ...
                <span className="benefit-desc">
                  e-commerce +20 %/an, IA, data centers.
                </span>
              </div>
            </li>
            ...
            <li>
              ...
              <div className="benefit-text">
                ...
                <span className="benefit-desc">
                  100 000 diplômés/an en tech, management & ingénierie.
                </span>
              </div>
            </li>
          </ul>
